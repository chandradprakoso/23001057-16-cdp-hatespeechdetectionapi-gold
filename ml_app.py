...
gr.Interface(fn=data_processing, inputs="text", outputs="text", title="Data Processing and Modeling",description="Aplikasi Web Data Processing dan Modeling",).launch()
